...
def get_state(octasonic):
    distance0 = octasonic.get_sensor_reading(2)   # faced front
    distance1 = octasonic.get_sensor_reading(1)   # faced right
    distance2 = octasonic.get_sensor_reading(7)   # faced left
